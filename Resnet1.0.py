...
# 示例数据
X = np.random.rand(1000, 128, 128, 3)
...
# 定义不同的模型
model_ethnicity = create_resnet_model(input_shape, num_classes)
model_gender = create_resnet_model(input_shape, num_classes)
model_age = create_resnet_model(input_shape, num_classes)

# 示例训练和测试数据
X_train_ethnicity = np.random.rand(800, 128, 128, 3)
y_train_ethnicity = np.random.randint(0, 10, size=(800, 10))
X_test_ethnicity = np.random.rand(200, 128, 128, 3)
y_test_ethnicity = np.random.randint(0, 10, size=(200, 10))

X_train_gender = np.random.rand(800, 128, 128, 3)
y_train_gender = np.random.randint(0, 10, size=(800, 10))
X_test_gender = np.random.rand(200, 128, 128, 3)
y_test_gender = np.random.randint(0, 10, size=(200, 10))

X_train_age = np.random.rand(800, 128, 128, 3)
y_train_age = np.random.randint(0, 10, size=(800, 10))
X_test_age = np.random.rand(200, 128, 128, 3)
